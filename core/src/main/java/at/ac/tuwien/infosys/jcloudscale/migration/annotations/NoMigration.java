...
/**
 * Classes annotated with {@link NoMigration} are (by default) excluded from
 * automatic migrations. If the user wants to migrate such an object she has to
 * explicitly call an appropriate migration method using the {@link CloudObject}
 * 's id as parameter.
 * 
