...
public class ObjectWithInfo {
	...
	@CloudInvocationInfos
	public List<InvocationInfo> infos = null;
	
	public ObjectWithInfo() {}
	
	public @ByValueParameter List<InvocationInfo> getInfos() {
		return infos;
	}
	
	public void doStuff(long time) throws InterruptedException {
		Thread.sleep(time);
	}
