...
public class TestEventDrivenScalingPolicyLocal extends at.ac.tuwien.infosys.jcloudscale.test.integration.base.TestEventDrivenScalingPolicy {
	
	@Before
	public void setup() throws Exception 
	{
		JCloudScaleClient.setConfiguration(ConfigurationHelper.createDefaultTestConfiguration()
				.withMonitoring(false)//someone has to check what happens when monitoring is disabled.
				.build());
