...
public class HbaseLongTypeAdapter implements TypeAdapter<Long, HbaseCell> {

    @Override
    public HbaseCell serialize(Long object, TypeMetadata<HbaseCell> typeMetadata) {
    ...
    @Override
    public Long deserialize(HbaseCell element, TypeMetadata<HbaseCell> typeMetadata) {
