...
public class HbaseFloatTypeAdapter implements TypeAdapter<Float, HbaseCell> {

    @Override
    public HbaseCell serialize(Float object, TypeMetadata<HbaseCell> typeMetadata) {
    ...
    @Override
    public Float deserialize(HbaseCell element, TypeMetadata<HbaseCell> typeMetadata) {
