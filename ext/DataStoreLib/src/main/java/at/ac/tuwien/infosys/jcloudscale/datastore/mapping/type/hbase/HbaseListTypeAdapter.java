...
public class HbaseListTypeAdapter implements TypeAdapter<List<?>, HbaseCell> {

    @Override
    public HbaseCell serialize(List<?> object, TypeMetadata<HbaseCell> typeMetadata) {
        ...
        JsonElement jsonElement = new JsonListTypeAdapter().serialize(object, jsonTypeMetadata);
