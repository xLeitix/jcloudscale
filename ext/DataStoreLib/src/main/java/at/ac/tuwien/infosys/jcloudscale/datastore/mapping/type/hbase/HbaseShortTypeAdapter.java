...
public class HbaseShortTypeAdapter implements TypeAdapter<Short, HbaseCell> {

    @Override
    public HbaseCell serialize(Short object, TypeMetadata<HbaseCell> typeMetadata) {
    ...
    @Override
    public Short deserialize(HbaseCell element, TypeMetadata<HbaseCell> typeMetadata) {
