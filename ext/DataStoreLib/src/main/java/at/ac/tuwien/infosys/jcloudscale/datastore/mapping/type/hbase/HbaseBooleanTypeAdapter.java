...
public class HbaseBooleanTypeAdapter implements TypeAdapter<Boolean, HbaseCell> {

    @Override
    public HbaseCell serialize(Boolean object, TypeMetadata<HbaseCell> typeMetadata) {
    ...
    @Override
    public Boolean deserialize(HbaseCell element, TypeMetadata<HbaseCell> typeMetadata) {
