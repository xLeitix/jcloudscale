...
public class UpdateWork extends AbstractWork {

    private Object entity;

    public UpdateWork(Object entity) {
        this.entity = entity;
    }
    ...
    public void doWork(Session session) {
        ...
        updateFieldsInDatastore(datastoreFieldDtos, datastoreModels);
    }

    private void updateFieldsInDatastore(List<DatastoreFieldDto> datastoreFieldDtos, List<DatastoreModel> datastoreModels) {
        for(DatastoreFieldDto datastoreFieldDto : datastoreFieldDtos) {
            ...
            datastoreFieldHandler.update(datastoreFieldDto, datastoreModel);
        }
    }
}
