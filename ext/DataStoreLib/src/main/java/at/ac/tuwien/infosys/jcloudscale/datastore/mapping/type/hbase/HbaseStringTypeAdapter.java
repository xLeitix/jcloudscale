...
public class HbaseStringTypeAdapter implements TypeAdapter<String, HbaseCell> {

    @Override
    public HbaseCell serialize(String object, TypeMetadata<HbaseCell> typeMetadata) {
    ...
    @Override
    public String deserialize(HbaseCell element, TypeMetadata<HbaseCell> typeMetadata) {
