...
public class JsonByteTypeAdapter implements TypeAdapter<Byte, JsonElement> {

    @Override
    public JsonElement serialize(Byte object, TypeMetadata<JsonElement> typeMetadata) {
        return new JsonPrimitive(object);
    }

    @Override
    public Byte deserialize(JsonElement element, TypeMetadata<JsonElement> typeMetadata) {
