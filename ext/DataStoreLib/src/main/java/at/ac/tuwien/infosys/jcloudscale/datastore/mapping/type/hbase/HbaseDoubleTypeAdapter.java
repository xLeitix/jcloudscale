...
public class HbaseDoubleTypeAdapter implements TypeAdapter<Double, HbaseCell> {

    @Override
    public HbaseCell serialize(Double object, TypeMetadata<HbaseCell> typeMetadata) {
    ...
    @Override
    public Double deserialize(HbaseCell element, TypeMetadata<HbaseCell> typeMetadata) {
