...
public class HbaseByteTypeAdapter implements TypeAdapter<Byte, HbaseCell> {

    @Override
    public HbaseCell serialize(Byte object, TypeMetadata<HbaseCell> typeMetadata) {
    ...
    @Override
    public Byte deserialize(HbaseCell element, TypeMetadata<HbaseCell> typeMetadata) {
